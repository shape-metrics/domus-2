...
void delete_glucose_temp_files(const std::string& output_file, const std::string& proof_file) {
...
GlucoseResult launch_glucose(const std::string& conjunctive_normal_form_file, bool randomize) {
    ...
    if (randomize) {
        ...
        command = "./glucose " + conjunctive_normal_form_file + " " + output_file + " -certified " +
                  proof_path;
    }
