...
generate_connected_random_graph_degree_max_4(const size_t number_of_nodes,
...
// n*m grid, n, m > 1
std::unique_ptr<UndirectedSimpleGraph> generate_grid_graph(const size_t n, const size_t m) {
